...
#function to return a more clear python panda DataFrame of a given dataframe function needs to be unique for each fcs and fbs due to column names being different
...
#function to return a more clear python panda DataFrame of a given dataframe of fcs teams
